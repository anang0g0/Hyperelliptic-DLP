...
ZZ  PP=to_ZZ("100000000000000003");
...
// ZZ  ff[2][7]={{1,0,0,0,0,2,0,2},{0,0,1,0,0,0,1,2}}; //GF(3^7,5^5)
...
ZZ  u1,u0,v1,v0,vu,vv,mm1,mm2,mm3,mm4,z1,z2,t1,t2,t3,t4,l2,l1,l3,d,aa,bb,cc,dd,ee,ue1,ue0,uue1,ve1,ve0,uue0,uu1,uu0;
Div D2;
vec vx;
unsigned f2,f3;
OP u,v;
...
vec vx=o2v(ff);
ZZ  d0,uv010,uu1,uu0,uuv11,d1,d2,d3,d4,d5,f2,e0,e1,f1,f3,mm0,mm1,mm3,mm4,s1,s2,l1,l0,l2,l3,u31,u30,v31,v30,uue0,uue1,iv,uuv01,uuv10,uuv00,u1,u0,v1,v0;
OP u,v;
Div D2;
f3=vx.x[3];
f2=vx.x[2];
...
ZZ pow_mod(__int128_t x, __int128_t n, __int128_t p)
{
  if (n == 0)
    return 1;
  if (n & 1)
...
ZZ tonelli_shanks(ZZ n, ZZ p)
{
 ...
 ZZ m = s;
  while (t != 1)
  {
   ...
   ZZ b = pow_mod(c, pow_mod(2, m - i - 1, p - 1), p);
   ZZ b2 = (b * b) % p;
    r = (r * b) % p;
    t = (t * b2) % p;
    c = b2;
