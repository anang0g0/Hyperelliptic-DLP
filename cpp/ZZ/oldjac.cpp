...
ZZ P = to_ZZ("100000000000000003"); // Harley's example
//ZZ P2=to_ZZ("10000000000000000051");
//ZZ P =to_ZZ("5000000000000000008503491");
ZZ Pusa=to_ZZ("340282366920938463463374607431768211283");
...
/*
//ZZ P=to_ZZ("170141183460469231731687303715884105727");
ZZ J3 = to_ZZ("28948022309329048848169239995659025138451177973091551374101475732892580332259");
//which is 254 bits. A possible degree 5 model is C : y2 = x**5 + f3*x**3 + f2*x**2 + f1x + f0, where
ZZ f[K+1] = {to_ZZ("1"),to_ZZ("0"),to_ZZ("34744234758245218589390329770704207149"),  to_ZZ("132713617209345335075125059444256188021"), 90907655901711006083734360528442376758,  6667986622173728337823560857179992816};
*/
...
//  unsigned long long tst2[K + 1] = {0, 0, 0, 0, 0, 10};
 // unsigned tmp[2][3] = {0};
  ...
  int a1 = 1331;
//  ZZ f[K+1]={to_ZZ("1"),to_ZZ("0"),to_ZZ("0"),to_ZZ("0"),to_ZZ("1331")};
